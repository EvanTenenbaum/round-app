  ...
  return (
    <main className="min-h-screen bg-[#FFF9F3]">
      ...
      <section className="max-w-5xl mx-auto px-6 pt-20 pb-24 text-center">
        ...
        <p className="text-sm text-[#BFB3A8] mt-6">Free forever for 1 circle · No credit card required</p>
      </section>
          ...
          {[
            {
              ...
              desc: 'Invite 3–8 neighbors or friends. Or use our matching to find a compatible circle near you.',
            },
            {
            ...
            },
            {
              ...
              desc: "Post what you're cooking, save seats in your circle, and arrange easy doorstep pickups.",
            },
          ...
          {[
            {
              ...
              price: '$0',
              note: 'forever',
              features: ['1 circle', 'Unlimited meals', 'Basic scheduling', 'Push notifications'],
              cta: 'Get started',
              href: '/signup',
              featured: false,
            },
            {
              ...
              features: ['Unlimited circles', 'Smart matching', 'Full meal history', 'AI meal suggestions'],
            ...
            },
            {
              ...
              price: '$49',
              note: 'one-time (launch only)',
              features: ['Everything in Round Member', 'No recurring charges', 'Priority support', 'Early access to new features'],
